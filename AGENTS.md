...
This is now a local CLI/JSONL Agent bridge. The current user request explicitly removes the network chat integration and adds Codex. README.md and docs/DESIGN.md are the sole current behavior contract. docs/IMPLEMENTATION.md records implementation choices; docs/verification.md records actual evidence.
