...
export class Store {
  ...
  constructor(file: string, private c: Config, readOnly = false) {
    ...
    try {
      ...
      invariant(version === 0 || version === 2, version === 1 ? 'LEGACY_STATE_REQUIRES_NEW_ROOT' : 'SCHEMA_TOO_NEW');
      this.db.exec('PRAGMA busy_timeout=5000;');
      if (readOnly) {
        invariant(version === 2, 'STATE_NOT_INITIALIZED');
  ...
  reserve(incoming: Incoming, kind: 'agent' | 'command'): {job: Job; duplicate: boolean} {
    return this.atomic(() => {
